              ...
              <div style={{ marginTop: 10, fontSize: 13 }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    ...
                    {s.theoryFabric > 0 && <tr style={{ borderBottom: '1px solid #f0f0f0' }}>
                      <td style={{ padding: '4px 0', color: '#888', fontSize: 11 }}>布料用量差异</td>
                      <td colSpan={2} style={{ textAlign: 'right', fontSize: 11 }}>
                        <span style={{ color: '#888' }}>理论 {s.theoryFabric.toFixed(1)}米</span>
                        <span style={{ color: '#888', margin: '0 4px' }}>|</span>
                        <span style={{ color: '#888' }}>领取 {s.actualFabric.toFixed(1)}米</span>
                        <span style={{ color: '#888', margin: '0 4px' }}>|</span>
                        <span style={{ color: s.fabricDiff > 0 ? '#A32D2D' : s.fabricDiff < 0 ? '#BA7517' : '#1D9E75', fontWeight: 600 }}>{s.fabricDiff > 0 ? '+' : ''}{s.fabricDiff.toFixed(1)}米</span>
                      </td>
                    </tr>}
                    <tr style={{ borderBottom: '1px solid #f0f0f0' }}>
                    ...
                    <tr style={{ borderBottom: '1px solid #f0f0f0' }}>
                      <td style={{ padding: '4px 0', color: '#888', fontSize: 11 }}>辅料来源</td>
                      <td colSpan={2} style={{ textAlign: 'right', fontSize: 11, color: '#888' }}>
                        关联领取 ¥{fmt(s.linkedMaterialCost || 0)} + 分摊 ¥{fmt(s.sharedMaterialCost || 0)}
                      </td>
                    </tr>
                    <tr style={{ borderBottom: '1px solid #f0f0f0' }}>
